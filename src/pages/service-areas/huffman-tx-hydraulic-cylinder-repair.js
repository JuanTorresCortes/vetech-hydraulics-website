  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`${BUSINESS.siteUrl}/service-areas/huffman-tx-hydraulic-cylinder-repair`}
        />
        <meta name="keywords" content="hydraulic cylinder repair Huffman TX, hydraulic repair Huffman Texas, hydraulic cylinder repacking Huffman TX, hydraulic service near Huffman TX" />
        <meta property="og:title" content="Hydraulic Cylinder Repair in Huffman, TX | Vetech Hydraulics" />
        <meta property="og:description" content="Vetech Hydraulics provides hydraulic cylinder repair, repacking, and testing in Huffman, TX. Text a picture of your cylinder for a fast quote." />
        <meta property="og:url" content={`${BUSINESS.siteUrl}/service-areas/huffman-tx-hydraulic-cylinder-repair`} />
