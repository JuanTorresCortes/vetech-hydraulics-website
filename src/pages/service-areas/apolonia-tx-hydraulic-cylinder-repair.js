...
export default function ApoloniaServicePage() {
  return (
    <>
      <Head>
        <title>Hydraulic Cylinder Repair in Apolonia, TX | Vetech Hydraulics</title>
        <meta
          name="description"
          content="Vetech Hydraulics provides hydraulic cylinder repair, repacking, and testing in Apolonia, TX. Text a picture of your cylinder for a fast quote."
        />
        <link
          rel="canonical"
      ...
      <AltSection>
        ...
        >
          ...
          >
            Vetech Hydraulics services equipment owners in Apolonia, TX and the surrounding
      ...
      <Section>
        ...
        >
          <SectionTitle subtitle="Text a picture for a fast response.">
            Need Hydraulic Cylinder Repair in Apolonia, TX?
          </SectionTitle>
          ...
          >
            If you&apos;re near Apolonia and dealing with a leaking or weak cylinder,
