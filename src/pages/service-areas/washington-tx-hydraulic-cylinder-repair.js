...
export default function WashingtonServicePage() {
  return (
    <>
      <Head>
        <title>Hydraulic Cylinder Repair in Washington, TX | Vetech Hydraulics</title>
        <meta
          name="description"
          content="Vetech Hydraulics provides hydraulic cylinder repair, repacking, and testing in Washington, TX. Text a picture of your cylinder for a fast quote."
        />
        <link
          rel="canonical"
      ...
      <AltSection>
        ...
        >
          ...
          >
            Hydraulic Cylinder Repair in Washington, Texas
          </Typography>

          <Typography
            sx={{ color: "rgba(255,255,255,0.8)", maxWidth: 720, mb: 3 }}
          >
            Vetech Hydraulics services equipment owners in Washington, TX and the surrounding
      ...
      <Section>
        ...
        >
          <SectionTitle subtitle="Text a picture for a fast response.">
            Need Hydraulic Cylinder Repair in Washington, TX?
          </SectionTitle>
          ...
          >
            If you&apos;re near Washington and dealing with a leaking or weak cylinder,
