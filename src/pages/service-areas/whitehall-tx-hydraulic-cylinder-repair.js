...
export default function WhitehallServicePage() {
  return (
    <>
      <Head>
        <title>Hydraulic Cylinder Repair in Whitehall, TX | Vetech Hydraulics</title>
        <meta
          name="description"
          content="Vetech Hydraulics provides hydraulic cylinder repair, repacking, and testing in Whitehall, TX. Text a picture of your cylinder for a fast quote."
        />
        <link
          rel="canonical"
          href="https://www.vetechhydraulics.com/service-areas/whitehall-tx-hydraulic-cylinder-repair"
        />
      </Head>
      ...
      <AltSection>
        ...
        >
          ...
          >
            Hydraulic Cylinder Repair in Whitehall, Texas
          </Typography>

          <Typography
            sx={{ color: "rgba(255,255,255,0.8)", maxWidth: 720, mb: 3 }}
          >
            Vetech Hydraulics services equipment owners in Whitehall, TX and the surrounding
      ...
      <Section>
        ...
        >
          <SectionTitle subtitle="Text a picture for a fast response.">
            Need Hydraulic Cylinder Repair in Whitehall, TX?
          </SectionTitle>
          ...
          >
            If you&apos;re near Whitehall and dealing with a leaking or weak cylinder,
