...
export default function AndersonServicePage() {
  return (
    <>
      <Head>
        <title>Hydraulic Cylinder Repair in Anderson, TX | Vetech Hydraulics</title>
        <meta
          name="description"
          content="Vetech Hydraulics provides hydraulic cylinder repair, repacking, and testing in Anderson, TX. Text a picture of your cylinder for a fast quote."
        />
        <link
          rel="canonical"
      ...
      <AltSection>
        ...
        >
          ...
          >
            Vetech Hydraulics services equipment owners in Anderson, TX and the surrounding
      ...
      <Section>
        ...
        >
          <SectionTitle subtitle="Text a picture for a fast response.">
            Need Hydraulic Cylinder Repair in Anderson, TX?
          </SectionTitle>
          ...
          >
            If you&apos;re near Anderson and dealing with a leaking or weak cylinder,
