      ...
      <AltSection>
        <Container maxWidth={false} disableGutters sx={{ px: { xs: 2, sm: 3 }, maxWidth: "1100px", mx: "auto" }}>
          ...
          <Typography sx={{ color: "rgba(255,255,255,0.8)", maxWidth: 780, mb: 2, lineHeight: 1.75 }}>
            Vetech Hydraulics serves equipment operators in Huntsville, TX and Walker County
            with hydraulic cylinder repair, repacking, and pressure-tested rebuilds. Huntsville
            sits along I-45 in the heart of the Piney Woods — a region with active timber
            operations, agriculture, and a strong base of construction and municipal equipment
            that depends on working hydraulics every day.
          </Typography>
          <Typography sx={{ color: "rgba(255,255,255,0.8)", maxWidth: 780, mb: 2, lineHeight: 1.75 }}>
