  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`${BUSINESS.siteUrl}/service-areas/hempstead-tx-hydraulic-cylinder-repair`}
        />
        <meta name="keywords" content="hydraulic cylinder repair Hempstead TX, hydraulic repair Hempstead Texas, hydraulic cylinder repacking Hempstead TX, hydraulic service near Hempstead TX" />
        <meta property="og:title" content="Hydraulic Cylinder Repair in Hempstead, TX | Vetech Hydraulics" />
        <meta property="og:description" content="Vetech Hydraulics provides hydraulic cylinder repair, repacking, and testing in Hempstead, TX. Text a picture of your cylinder for a fast quote." />
        <meta property="og:url" content={`${BUSINESS.siteUrl}/service-areas/hempstead-tx-hydraulic-cylinder-repair`} />
      ...
      <Box component="section" sx={{ position: "relative", minHeight: { xs: "60svh", md: "68vh" }, overflow: "hidden", display: "flex", alignItems: "center" }}>
        <Box sx={{ position: "absolute", inset: 0, transformOrigin: "center center", animation: `${zoomOut} 8s ease-out forwards` }}>
          <Image src={heroImg} alt="Hydraulic equipment in Hempstead TX" fill priority sizes="100vw" style={{ objectFit: "cover", objectPosition: "center" }} />
        </Box>
