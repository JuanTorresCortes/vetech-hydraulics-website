  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Vetech Hydraulics provides hydraulic cylinder repair, repacking, and testing in New Caney, TX. Text a picture of your cylinder for a fast quote."
        />
        <link
          rel="canonical"
          href={`${BUSINESS.siteUrl}/service-areas/new-caney-tx-hydraulic-cylinder-repair`}
        />
        <meta name="keywords" content="hydraulic cylinder repair New Caney TX, hydraulic repair New Caney Texas, hydraulic cylinder repacking New Caney TX, hydraulic service near New Caney TX" />
        <meta property="og:title" content="Hydraulic Cylinder Repair in New Caney, TX | Vetech Hydraulics" />
        <meta property="og:description" content="Vetech Hydraulics provides hydraulic cylinder repair, repacking, and testing in New Caney, TX. Text a picture of your cylinder for a fast quote." />
      ...
      <AltSection>
        ...
        >
          ...
          >
            Vetech Hydraulics services equipment owners in New Caney, TX and the surrounding area with hydraulic cylinder repacking, rod work, and pressure-tested rebuilds. Text or email a photo of your cylinder and we&apos;ll help you choose the best repair plan.
          </Typography>
      ...
      <Section>
        ...
        >
          <SectionTitle subtitle="Text a picture for a fast response.">
            Need Hydraulic Cylinder Repair in New Caney, TX?
          </SectionTitle>
          ...
          >
            If you&apos;re near New Caney and dealing with a leaking or weak cylinder,
