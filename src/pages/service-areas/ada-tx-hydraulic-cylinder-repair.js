  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Vetech Hydraulics provides hydraulic cylinder repair, repacking, and testing in Ada, TX. Text a picture of your cylinder for a fast quote."
        />
        <link
          rel="canonical"
      ...
      <AltSection>
        ...
        >
          ...
          >
            Vetech Hydraulics services equipment owners in Ada, TX and the surrounding
      ...
      <Section>
        ...
        >
          <SectionTitle subtitle="Text a picture for a fast response.">
            Need Hydraulic Cylinder Repair in Ada, TX?
          </SectionTitle>
          ...
          >
            If you&apos;re near Ada and dealing with a leaking or weak cylinder,
