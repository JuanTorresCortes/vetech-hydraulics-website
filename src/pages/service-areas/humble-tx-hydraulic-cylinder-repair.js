  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Vetech Hydraulics provides hydraulic cylinder repair, repacking, and testing in Humble, TX. Text a picture of your cylinder for a fast quote."
        />
        <link
          rel="canonical"
          href={`${BUSINESS.siteUrl}/service-areas/humble-tx-hydraulic-cylinder-repair`}
        />
        <meta name="keywords" content="hydraulic cylinder repair Humble TX, hydraulic repair Humble Texas, hydraulic cylinder repacking Humble TX, hydraulic service near Humble TX" />
        <meta property="og:title" content="Hydraulic Cylinder Repair in Humble, TX | Vetech Hydraulics" />
        <meta property="og:description" content="Vetech Hydraulics provides hydraulic cylinder repair, repacking, and testing in Humble, TX. Text a picture of your cylinder for a fast quote." />
      ...
      <AltSection>
        ...
        >
          ...
          >
            Vetech Hydraulics services equipment owners in Humble, TX and the surrounding area with hydraulic cylinder repacking, rod work, and pressure-tested rebuilds. Text or email a photo of your cylinder and we&apos;ll help you choose the best repair plan.
          </Typography>
      ...
      <Section>
        ...
        >
          <SectionTitle subtitle="Text a picture for a fast response.">
            Need Hydraulic Cylinder Repair in Humble, TX?
          </SectionTitle>
          ...
          >
            If you&apos;re near Humble and dealing with a leaking or weak cylinder,
